<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="dropdown active">
            <a href="{{route('admin.admin.dashboard')}}" class="nav-link"><i class="fas fa-fire"></i><span>Dashboard</span></a>
        </li>
        ...
        'admin.slider.*'
            ...
            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Slider Manage</span></a>
            <ul class="dropdown-menu">
